...
A select should be used with child `<gic-select-option>` elements. If the child option is not given a `value` attribute then its text will be used as the value.

If `value` is set on the `<gic-select>`, the selected option will be chosen based on that value. Otherwise, the `selected` attribute can be used on the `<gic-select-option>`.
...
| `searchBar`        | `search-bar`         | If `true`, the select will show a searchbar for radios and checkboxes                                                                                                                                                                                                                                                                                                             | `boolean`                                                                            | `true`         |
| `selectedText`     | `selected-text`      | The text to display instead of the selected option's value.                                                                                                                                                                                                                                                                                                                       | `null \| string \| undefined`                                                        | `undefined`    |
| `useVirtualScroll` | `use-virtual-scroll` | If `true`, the buttons list will be rendered in a virtual scroll                                                                                                                                                                                                                                                                                                                  | `boolean`                                                                            | `true`         |
